...
_Transformer_instances = new WeakSet(), _Transformer_collectSymbol = function _Transformer_collectSymbol(name, context) {
...
}, _Transformer_transformColumn = function _Transformer_transformColumn(column, context, schema) {
    let args = __classPrivateFieldGet(this, _Transformer_instances, "m", _Transformer_transformColumnToArgs).call(this, column, context, schema);
    if (column.isArray) {
    ...
    return node;
}, _Transformer_transformColumnToArgs = function _Transformer_transformColumnToArgs(column, context, schema) {
    ...
    for (const table of context.metadata.tables) {
        ...
        for (const column of table.columns) {
            ...
            const value = __classPrivateFieldGet(this, _Transformer_instances, "m", _Transformer_transformColumn).call(this, column, context, table.schema);
