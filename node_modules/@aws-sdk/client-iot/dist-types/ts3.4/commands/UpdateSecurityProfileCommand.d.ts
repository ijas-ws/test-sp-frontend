...
export interface UpdateSecurityProfileCommandOutput
  extends UpdateSecurityProfileResponse,
    __MetadataBearer {}
export declare class UpdateSecurityProfileCommand extends $Command<
