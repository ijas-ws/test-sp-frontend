...
export function BackNodeHapiPg({ stack }) {
	const clientName = "back";
	const environment = "develop";
	const dbName = `back_database_${environment}`;
  ...
  databaseCredentialsSecret.grantRead(executionRole);
	...
	const image = ecs.ContainerImage.fromAsset("back-node-hapi-pg/", {
